...
role_name: Technology Portfolio Director
opens: 'TBD'
closes: 'TBD'
...
You will need a thorough knowledge of infrastructure, networking, cloud, integration, data, custom & packaged applications, and security to ensure that TTS’ infrastructure offerings and architecture meets current and future needs in an efficient, sustainable, agile, and adaptable manner. You will be responsible for: 

- Information System Security (Ensuring monitoring, compliance and reporting requirements are met.) 
- Systems governance
- Technology Infrastructure
- IT portfolio management (Process, including acquisition - customer centric compliance/ transparency)
- Sandboxing/piloting
- Developing TTS's data strategy and engaging on data governance related issues within the broader GSA
...
### Key objective #1: Serving as the innovative technical leader, you will develop strategies and execute initiatives to modernize TTS’ systems and infrastructure, empowering TTS to better deliver on its mission.

- Partnering with others in TTS’ operations, produce and execute on an overall technical strategy, investment, and acquisition plan for TTS that results in lower costs, availability of highly usable software and infrastructure and higher velocity. 
- Use modern research methods or internal TTS research resources to fully understand the real needs of TTS users and the impact driven by systems & cloud infrastructure
...
- Own TTS Bug Bounty program 

### Key objective #2: Act as the primary liaison to other key IT providers and stakeholders such as GSA IT and [FAS Office of Systems Management](https://www.gsa.gov/about-us/organization/federal-acquisition-service/office-of-systems-management).
...
- Coordinate with TTS Office of Acquisition on developing and enforcing policy of FITARA and IT Standardsreview of acquisitions
  - Information System and Software Authorizations:
  - Serve as Authorizing Official for TTS systems up to the Moderate impact level, signing all ATOs
  - Serve as delegated Authorizing Official for High impact systems
  - Accept risk on behalf of the Government, lead all risk evaluation and management methodologies
...
- Skillfully map specific inquiries to product capabilities, identifying the product that best meets the TTS’ needs
...
2. Thorough knowledge of infrastructure, networking, cloud, integration, data, custom & packaged applications, and security
3. The ability to methodically solve business and technical problems using innovative and well-planned approaches with well documented, supportable and extensible developments
